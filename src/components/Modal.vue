...
<template>
  <TransitionRoot as="template" :show="storeModal.modal">
    <Dialog
      as="div"
      class="relative z-10"
      @close="storeModal.handleClickModal()"
    >
      <TransitionChild
        as="template"
            ...
            >
              <div>
                <div class="mt-3">
                  <DialogTitle
                    as="h3"
                    class="text-4xl font-extrabold leading-6 text-gray-900 my-5 text-center"
                  >
                    {{ storeBebida.receta.strDrink }}
                  </DialogTitle>
                  <img
              ...
              <div class="mt-5 sm:mt-6 flex justify-between gap-4">
                <button
                  type="button"
                  class="w-full rounded bg-gray-600 p-3 font-bold uppercase text-white shadow hover:bg-gray-500 text-lg"
